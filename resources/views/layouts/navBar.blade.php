            ...
            <div class="bg-white">
                <div class="container d-flex">
                    ...
                    <div class="login-info ms-auto">
                        ...
                        <span class="fw-bold" style="color: red;"><i class="fas fa-user-circle px-1"></i>Seller : {{ session('name') }}</span>
            ...
            <div class="container py-1 px-5" style="background: darkblue; border-radius: 30px">
                ...
                <div class="navbar-nav ms-auto text-uppercase">
                    ...
                    <div class="dropdown show">
                        <a class="fw-bold nav-link mx-2 text-white dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Category
                        </a>

                        <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item fw-bold nav-link mx-2 text-danger" href="{{ route ('supplement') }}">Supplement & vitamines</a>
                          <a class="dropdown-item fw-bold nav-link mx-2 text-danger" href="{{ route ('medicine') }}">Medicine</a>
                    ...
                    @elseif(session('role')=='service')
                    <a class="fw-bold nav-link mx-2  text-white" href="{{ route ('serviceProviderDashboard') }}">Dashboard</a>
                    @elseif(session('role') == 'seller')
